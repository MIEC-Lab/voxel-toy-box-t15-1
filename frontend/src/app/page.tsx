        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-[1.35fr_0.9fr] lg:items-start">
          <div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              ...
              visual, browser-based experience. Users will be able to start a
              match, inspect round-by-round agent behavior, and review final
          ...
          <div className="rounded-[32px] border border-white/10 bg-white/7 p-6 shadow-2xl shadow-cyan-900/20 backdrop-blur">
            <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-6">
              ...
              <div className="mt-6 space-y-4 text-sm leading-7 text-slate-300">
                ...
                <div className="rounded-2xl border border-white/8 bg-white/5 p-4">
                  A start page, results page, and round-by-round visualization.
                </div>
                <div className="rounded-2xl border border-white/8 bg-white/5 p-4">
